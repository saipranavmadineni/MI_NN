...
Original file is located at
    https://colab.research.google.com/drive/1VFUx5gFaQ4LngoHkPs3iq6ylIH9wI8_P
"""
...
class NN(object):
    ...
    def predict(self, a):
        ...
        for w, b in zip(self.weights, self.biases):
            ...
            z = np.dot(w, a) + b
            a = activation(z)
        predictions = (abs(a) > 0.47).astype(int)
        return predictions
...
if __name__ == "__main__":
    df=pd.read_csv("./data/preprocessed.csv",index_col=0)#ignoring the first coloumn
    ...
    neural_net = NN([9,18,9,9, 1],seed=42)
